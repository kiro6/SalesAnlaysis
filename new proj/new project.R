...
compare_age_spending <- data.frame(
  ...
  total = c(total_1_to_10 ,total_11_to_20  , total_21_to_30 , total_31_to_40 , total_41_to_up)
...
apriori_rules = apriori(transactions , parameter = list(supp  = min_support , conf = min_confidance , minlen =2) )
